...
namespace TaskManager.DataAccess
{
    public class TaskManagerContextFactory : IDesignTimeDbContextFactory<TaskManagerContext>
    {
        public TaskManagerContext CreateDbContext(string[] args)
        {
            ...
            optionsBuildier.UseSqlServer("Server=tcp:taskmanagerserver.database.windows.net,1433;Initial Catalog=TaskManagerDb;Persist Security Info=False;User ID=wojtekwojtowiczadmin;Password=EprVumKo3cQjeMwZaY94;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
